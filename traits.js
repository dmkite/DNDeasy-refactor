...
function run(){
 return traits.reduce((acc, trait) =>{
    delete trait.index
    delete trait.ability_bonuses
    delete trait.starting_proficiency_options
    delete trait.languages
    delete trait.language_options
    delete trait.racial_traits
    delete trait.racial_trait_options
    delete trait.url
